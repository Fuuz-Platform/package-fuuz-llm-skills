---
name: fuuz-screens
description: "Generate Fuuz screen JSON for dashboards, tables, forms, and reports. Trigger on fuuz screen, screen designer, dashboard, table screen, form screen, fuuz UI, screen JSON, canvas design, or Fuuz UI construction. Covers 75 element types in 5 categories (Layout 12, Input 41, Data 8, Display 4, Interaction 10) with full property docs including Container, Form, Table, DisplayText, ActionButton, Chart, Icon, Tabs, Dialog, and ResizablePanel. Includes Screen Designer concepts (Craft.js architecture, element flags, shared field sets, field type glossary, transform dual-mode editing), required properties to prevent React render errors, JSONata context ($components, $appConfig, metadata), FusionCharts visualizations, FontAwesome icons, responsive flex layout, and dashboard production patterns. Cross-references fuuz-graphql for queries, fuuz-jsonata for expressions, fuuz-flows for backend flows."
---
